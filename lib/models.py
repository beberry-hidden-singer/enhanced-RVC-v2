"""modified from https://github.com/RVC-Project/Retrieval-based-Voice-Conversion-WebUI/blob/main/lib/infer_pack/models.py
by karljeon44"""
import math
...
from lib import attentions, commons, modules
from lib.commons import init_weights, get_padding
from lib.generator import GeneratorBigV
...
# class SineGenBigV(torch.nn.Module):
#   """Definition of sine generator
#   SineGen(samp_rate, harmonic_num = 0,
#           sine_amp = 0.1, noise_std = 0.003,
#           voiced_threshold = 0,
...
# class SourceModuleHnNSFBigV(torch.nn.Module):
#   """SourceModule for hn-nsf
#   SourceModule(sampling_rate, harmonic_num=0, sine_amp=0.1,
#                add_noise_std=0.003, voiced_threshod=0)
#   sampling_rate: sampling_rate in Hz
...
#   uv (batchsize, length, 1)
#
#   from https://github.com/PlayVoice/NSF-BigVGAN/blob/main/model/nsf.py#L358
#   """
#
#   def __init__(
#           self,
...
#     sine_wavs = F.linear(sine_wavs, self.merge_w) + self.merge_b
...
# class GeneratorBigV(torch.nn.Module):
#   def __init__(
#           self,
#           initial_channel,
#           resblock,
...
#
#     # pre conv
#     # self.conv_pre = weight_norm(Conv1d(initial_channel,
...
#         self.resblocks.append(bigv.AMPBlock(ch, k, d))
#
#     # post conv
#     self.activation_post = bigv.SnakeAlias(ch)
#     self.conv_post = Conv1d(ch, 1, 7, 1, padding=3, bias=False)
#     self.ups.apply(init_weights)
#
#     if gin_channels != 0:
