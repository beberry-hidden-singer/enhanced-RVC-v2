...
"""from https://github.com/PlayVoice/NSF-BigVGAN/blob/main/model/alias/filter.py"""
...
class LowPassFilter1d(nn.Module):
    def __init__(self,
        ...
        if C is not None:
            self.conv1d_block = nn.ModuleList([nn.Conv1d(C, C, kernel_size, stride=self.stride, groups=C, bias=False)])
