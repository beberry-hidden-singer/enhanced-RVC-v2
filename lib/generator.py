...
from lib.bigv import init_weights, AMPBlock, SnakeAlias
...
class SignalsConv1d(torch.nn.Module):
  ...
  def forward(self, signal, system_ir):
    ...
    signal_pad = F.pad(signal.permute(0, 2, 1), (padding_length, 0))
    ...
    # convolute
    output = F.conv1d(signal_pad, ir, groups=groups)
